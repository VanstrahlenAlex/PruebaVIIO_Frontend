...
const Busqueda = () => {
    ...
    const {buscador, handleBuscador, productos} = useProductos();
    const productosFiltrados = busqueda === '' ? [] : productos.filter(producto => producto.nombre.toLowerCase().includes(busqueda.toLowerCase()))
