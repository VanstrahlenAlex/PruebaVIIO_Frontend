...
const ModalEliminarColaborador = () => {
    ...
    const { handleModalEliminarColaborador, modalEliminarColaborador, eliminarColaborador} = useProductos();
    return (
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-500">Un Colaborador eliminado no  podrá volver a ser colaborador del producto.</p>
                                    </div>
                                </div>
                            </div>
